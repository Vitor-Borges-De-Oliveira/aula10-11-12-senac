...
try {
    $sql = "insert into tblvendas (idvendedor,idproduto,quantidade)
            values (:idvendedor,:idproduto,:quantidade)";
            ...
            <div class="row">               
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" name="idvendedor" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" name="idproduto" class="form-control" id="exampleInputPassword1">
                    </div>

                <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Quantidade</label>

                        <input type="text" name="quantidade" class="form-control" id="exampleInputPassword1">
                    </div>
                </div>
