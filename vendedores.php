...
try {
    $sql = "insert into tblvendedores (vendedor,dtadmissao,salario)
            values (:vendedor,:dtadmissao,:salario)";
...
<div class="row">               
    <div class="col">
        <div class="mb-3">
            ...
            <input type="text" name="vendedor" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
    </div>
    ...
    <div class="col">
        <div class="mb-3">
            ...
            <input type="text" name="dtadmissao" class="form-control" id="exampleInputPassword1">
        </div>
    </div>
    ...
    <div class="col">
        <div class="mb-3">
            ...
            <input type="text" name="salario" class="form-control" id="exampleInputPassword1">
        </div>
    </div>
